...
@endsection
@section('headerScrol')
<header id="headerScroll" style="background-color: #41ccae; height: 50px;">
	<div class="container">				
...
<div id="slider">
	<div id="demo" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			...
			@if($i==1) 
			<div class="carousel-item active">
				<img src="{{ asset('/storage/app/banImg/'.$ban->ban_img) }}" alt="" class="img-thumbnail">
			</div>
			@else 
			<div class="carousel-item">
				<img src="{{ asset('/storage/app/banImg/'.$ban->ban_img) }}" alt="" class="img-thumbnail">
	...
	<div class="products">
		...
		<div class="product-list row">
			...
			<div class="product-item col-md-4 col-sm-6 col-xs-12">
				...
				<p class="price"><del>{{number_format($item->p_price,0,',','.')}}</del>VND</p>	  
				<p class="price">{{number_format($item->p_price-$item->p_price*$item->p_promotion/100,0,',','.')}}VND</p>	  
				<div class="marsk">
